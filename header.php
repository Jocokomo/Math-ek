...
<body>
  <audio id="rosszValaszMp3">
    <source src="audio/rossz.mp3" type="audio/mpeg">
  </audio>
  <audio id="myAudio">
  ...
  <nav>
    <div class="wrapper">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="osszeadas.php">
        ...
        <li class="nav-item">
          <a class="nav-link" href="kivonas.php">
        ...
        <li class="nav-item">
          <a class="nav-link" href="szorzas.php">
        ...
        <li class="nav-item">
          <a class="nav-link" href="osztas.php">
        ...
        <?php
          if (isset($_SESSION["useruid"])) {
            ...
            echo "<li class='nav-item'><a class='nav-link' href='includes/logout.inc.php'>Kijelentkezés </a></li>";
          }
          else {
